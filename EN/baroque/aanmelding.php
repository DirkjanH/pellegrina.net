...
<!DOCTYPE HTML>
<html lang="en">
<!-- InstanceBegin template="/Templates/LP_aanmelding_EN.dwt.php" codeOutsideHTMLIsLocked="true" -->
...
<body>
  ...
  <div id="inhoud" class="w3-main"> <?php
      ...
      <!-- InstanceBeginEditable name="mainpage" --> <?php // Haal de inleiding + het NAW formulier op
                                                      require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/NAW_EN.php'; ?> <table
        class="formulier" id="instr_kop">
        <tr>
          ...
          <td>
            ...
            <SELECT NAME="instr[]" size="17" multiple>
              <OPTGROUP LABEL="Winds">
                <OPTION VALUE="112"
                  <?php
                  if (isset($instr) and stristr($instr, '112') !== false) echo 'selected'; ?>>traverso
                </OPTION>
                <OPTION VALUE="116"
                  <?php
                  if (isset($instr) and stristr($instr, '116') !== false) echo 'selected'; ?>>recorder
                </OPTION>
                <OPTION VALUE="122"
                  <?php
                  if (isset($instr) and stristr($instr, '122') !== false) echo 'selected'; ?>>baroque oboe
                </OPTION>
                <OPTION VALUE="141"
                  <?php
                  if (isset($instr) and stristr($instr, '141') !== false) echo 'selected'; ?>>baroque
                  bassoon</OPTION>
                <OPTION VALUE="160"
                  <?php
                  if (isset($instr) and stristr($instr, '160') !== false) echo 'selected'; ?>>baroque
                  trumpet</OPTION>
              </OPTGROUP>
              <OPTGROUP LABEL="Strings">
                <OPTION VALUE="210"
                  <?php
                  if (isset($instr) and stristr($instr, '210') !== false) echo 'selected'; ?>>violin
                </OPTION>
                <OPTION VALUE="220"
                  <?php
                ...
                <OPTION VALUE="240"
                  <?php
                  if (isset($instr) and stristr($instr, '240') !== false) echo 'selected'; ?>>double bass
                </OPTION>
                <OPTION VALUE="250"
                  <?php
                  if (isset($instr) and stristr($instr, '250') !== false) echo 'selected'; ?>>viola da gamba
                  [please indicate under 'remarks' which
                  instruments you play: descant, alto/tenor
                  and/or bass]</OPTION>
              </OPTGROUP>
              <OPTGROUP LABEL="Continuo instruments">
                <OPTION VALUE="320"
                  <?php
                  if (isset($instr) and stristr($instr, '320') !== false) echo 'selected'; ?>>harpsichord
                </OPTION>
                <OPTION VALUE="330"
                  <?php
                ...
                <OPTION VALUE="340"
                  <?php
                  if (isset($instr) and stristr($instr, '340') !== false) echo 'selected'; ?>>theorbo
                </OPTION>
              </OPTGROUP>
              <OPTION VALUE="000"
                <?php
                if (isset($instr) and stristr($instr, '000') !== false) echo 'selected'; ?>>other [please
                describe under 'remarks']</OPTION>
            </SELECT>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            <input name="zangstem" type="radio" value="10"
              <?php
              if (isset($_POST['zangstem']) and ($_POST['zangstem'] == "10")) echo 'checked'; ?>>soprano  <input type="radio"
              name="zangstem" value="20"
              <?php
              if (isset($_POST['zangstem']) and ($_POST['zangstem'] == "20")) echo 'checked'; ?>>mezzosoprano 
            <input type="radio" name="zangstem" value="30"
              <?php
              if (isset($_POST['zangstem']) and ($_POST['zangstem'] == "30")) echo 'checked'; ?>>alto  <input type="radio"
              name="zangstem" value="40"
              <?php
              if (isset($_POST['zangstem']) and ($_POST['zangstem'] == "40")) echo 'checked'; ?>>countertenor 
            <input type="radio" name="zangstem" value="50"
              <?php
              if (isset($_POST['zangstem']) and ($_POST['zangstem'] == "50")) echo 'checked'; ?>>tenor  <input type="radio"
              name="zangstem" value="60"
              <?php
        ...
        <tr>
          ...
          <td>I have&nbsp; <input name="ervaring_z" type="radio"
            ...
            <input type="radio" name="ensemble_z" value="enige"
              <?php
              if (isset($_POST['ervaring_z']) and ($_POST['ervaring_z'] == "enige")) echo 'checked'; ?>>some&nbsp; <input type="radio"
              name="ensemble_z" value="veel"
              <?php
      ...
      <table class="formulier">
        ...
        <tr>
          ...
          <td><input name="diner" type="checkbox" id="diner" value="1"
              ...
              Although I arrange my own accommodation, I also like
              to make use of the communal dinner<span
                class="nadruk"> (surcharge
          ...
          <td>
            <p><br> I intend to travel to the summer school in the
              ...
              <select name="vervoer" size="7" id="vervoer">
                ...
                <option value="train"
                  <?php
                  if (isset($_POST['vervoer']) and ($_POST['vervoer'] == "train")) echo 'selected'; ?>>by
                  train</option>
              </select>
            </p>
          </td>
      ...
      <p>Please see the <a href="praktisch.php" target="_blank">practical
          matters</a> page for convenient ways of international
        payment.</p>
      <hr>
      ...
      <table border="0">
        <tr>
          ...
          <td>I agree to the conditions stated in <a
              href="praktisch.php">Practical matters</a> and
            elsewhere on this site <span
              class="nadruk">(mandatory!)</span>. <br> I
            understand my personal data are stored for practical
            reasons related to the organisation of the summer
            school. They will never be shared with third parties
            without my explicit permission.</td>
        </tr>
      </table>
      <p><input name="submit" type="submit" value="send the form"><br>
        <span class="nadruk">(please click only once. You will see
          either the payment page or an automatic confirmation of
          receipt)</span>
      </p>
