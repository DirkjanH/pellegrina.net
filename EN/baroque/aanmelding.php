...
require_once $_SERVER['DOCUMENT_ROOT'].'/includes/NAW_EN.php'; ?>
              ...
              <tr>
                ...
                <td><p><b>I wish to play the following instrument(s): <span class="nadruk">(multiple
                  ...
                  <SELECT NAME="instr[]" size="17" multiple>
					...
					if (isset($instr) and stristr($instr, '116') !== false) echo 'selected'; ?>>recorder</OPTION>
                    <OPTION VALUE="122" <?php
					if (isset($instr) and stristr($instr, '122') !== false) echo 'selected'; ?>>baroque oboe</OPTION>
                    <OPTION VALUE="141" <?php
					if (isset($instr) and stristr($instr, '141') !== false) echo 'selected'; ?>>baroque bassoon</OPTION>
                    </OPTGROUP>
					...
					[please indicate under 'remarks' which instruments you play: descant, alto/tenor and/or bass]</OPTION>
                    </OPTGROUP>

					<OPTGROUP LABEL="Continuo instruments">
                    <OPTION VALUE="320" <?php
					if (isset($instr) and stristr($instr, '320') !== false) echo 'selected'; ?>>harpsichord</OPTION>
                    <OPTION VALUE="330" <?php
					if (isset($instr) and stristr($instr, '330') !== false) echo 'selected'; ?>>organ</OPTION>
                    <OPTION VALUE="340" <?php
					if (isset($instr) and stristr($instr, '340') !== false) echo 'selected'; ?>>theorbo</OPTION>
                    </OPTGROUP>
            ...
            <table class="formulier" id="zang_kop">
              <tr>
                ...
                <td><b>I register as a  singer.</b> <span class="nadruk">Please fill out the questions appearing below</span></td>
              </tr>
            </table>
...
<span class="nadruk">Standard accommodation is a place in a double room at the monastery hostel and full board. If that is what you want you don't need to indicate other wishes here.</span></p>
            <table class="formulier">
              <tr>
                ...
                <td>I prefer a single room <span class="nadruk">(surcharge <?php echo euro_en($cursusdata['eenpers']) ?>;
              ...
              <tr>
                ...
                <td>I would like to camp in the monastery garden <span class="nadruk">(reduction <?php echo euro_en($cursusdata['kamperen']) ?>;
                  availability limited )</span></td>
              </tr>
              <tr>
                ...
                <td>I arrange my own accommodation and make use only of the collective lunch, dinner and coffee/tea<span class="nadruk"> (reduction <?php echo euro_en($cursusdata['korting_eigen_acc']) ?>)</span></td>
              </tr>
			  <tr>
				  <td class="linkerkolom">&nbsp;</td><td><input name="diner" type="checkbox" id="diner" value="1"
				<?php if (isset($_POST['diner']) AND $_POST['diner'] == 1) echo 'checked'; ?>><label> Although I arrange my own accommodation, I also like to make use of the communal dinner<span class="nadruk"> (surcharge <?php echo euro_en($cursusdata['diner']) ?>)</span></label></td>
			  </tr>
            </table>
            ...
            <table>
              <tr>
                <td>&nbsp;</td>
                <td><p><br>
                  I intend to travel to the summer school in the following way: <span class="nadruk">(please select an option)</span><br>
                  <select name="vervoer" size="7" id="vervoer">
                    ...
                    <option value="train" <?php 
										if (isset($_POST['vervoer']) and ($_POST['vervoer'] == "train")) echo 'selected';?> >by train</option>
                    </select>
                </p></td>
              </tr>
              <tr>
                ...
                <td><br>
                  Different, i.e.:<br>
                  <textarea name="reistype" cols="70" rows="3"><?php if (isset($_POST['reistype'])) echo $_POST['reistype']; ?></textarea></td>
              </tr>
            </table>
            <hr>
            <table>
            ...
            <table border="0">
			  ...
			  <tr><td><input type="radio" name="betaling" value="transfer"></td>
			    <td><label>I will paid the deposit by bank transfer <span class="nadruk">(Use this option when the course fee is less than <?php echo euro_en($cursusdata['inschrijfgeld']*2); ?>, for example for the Central European or Czech prices. Paying the deposit is required for further processing)</span></label></td>
			  </tr>
            </table>   
