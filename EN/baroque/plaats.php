...
<body>
    ...
    <div id="inhoud" class="w3-main"> <?php
            ...
            <p>Monastery Nieuw Sion has existed since 1890 and was a Trappist
                ...
                Since then, a wide range of spiritual, as well as cultural and
                musical activities have taken place. More information can be
                found here:</p>
            <ul>
                <li><a href="https://indebuurt.nl/deventer/woning-van-de-week/binnenkijken-bij-klooster-nieuw-sion-de-monniken-zijn-verhuisd-maar-er-wonen-nog-wel-mensen~108570/"
                        target="_blank">An impression of the monastery
                        atmosphere</a></li>
                <li><a href="https://www.nieuwsion.nl/"
                        target="_blank">Monastery website (in Dutch)</a>
                </li>
            </ul>
