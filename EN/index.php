...
<body>
    ...
    <div id="inhoud">
        <div id="envelop" class="w3-hide-small w3-hide-medium">
            <div id="banner" class="">
                <div class="bannergeel">Registration for summer 2027 starts on
                    December 1!</div>
            </div>
            <div id="" class="onzichtbaar">
                <div class="bannergroen onzichtbaar">Registration for summer
                    2027 has started!</div>
            </div>
            <div id="" class="onzichtbaar">
                <div class="bannergeel">Who registers before March 1 receives
                    EUR 50 discount</div>
            </div>
            <div id="" class="onzichtbaar">
        ...
        <div id="main" class="w3-row-padding">
            <div class="w3-card-2 w3-padding w3-margin-bottom w3-half">
                ...
                <p>This page gives an overview of the courses in
                    ...
                    Deventer. The course around Haydn and Dvořák will take place
            ...
            <div class="w3-half">
                <div class="w3-card-2 w3-padding w3-margin-bottom">
                    <h3><a href="romantic/index.php"><span
                                class="romantic">Mendelssohn's Elijah for
                    ...
                    <p class="volvoor onzichtbaar">The course is full for all
                        instruments and voice types</p>
                </div>
                <div class="w3-card-2 w3-padding w3-margin-bottom">
                    <h3><a href="baroque/index.php"><span
                                class="baroque">Neapolitan Baroque in 415
                                Hz</span></a></h3>
                    <p>for singers &amp; 'early' instruments</p>
                    <ul>
                        <li>Priory Nieuw Sion, Diepenveen (Netherlands), 8 - 14
                            August 2027</li>
                    </ul>
                    <p class="plaatsvoor onzichtbaar">Still place for a tenor
                        with solistic abilities</p>
                    <p class="volvoor onzichtbaar">The course is full for all
                        voices and all instruments</p>
                </div>
