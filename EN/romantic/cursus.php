...
<body>
    ...
    <div id="inhoud" class="w3-main"> <?php
            ...
            <p>Every morning the choir singers will rehearse in the chamber
                choir, working on music by Mendelssohn (for example <em>Siehe,
                    der Hüter Israels </em>from the Oratorio <em> Elias</em>)
                and by Mitchell Sandler himself, to name a few works. Some
                singers can form combinations with instruments. For instance, a
                soprano could do Schubert's <em>Hirt auf dem Felsen </em>or
                Spohr's <em>Lieder </em>for voice, clarinet and piano. A
                baritone could work on Barber's <em>Dover Beach</em> with a
                string quartet. A few more suggestions: Pergolesi's <em>Stabat
                    Mater</em> with strings, Mozart and Haydn <em>Lieder
                </em>for several voices and piano, Telemann's <em>Harmonischer
                    Gottesdienst</em>, Schubert's <em>Hochzeitsbraten</em> or
                other Schubert works for several voices and piano, etc., etc.
            </p>
            ...
            <p class="citaat"><span tabindex="-1" id="result_box2"
                    lang="en"></span>Henriëtte Hamer: &quot;La Pellegrina
                invites you to do things you did not suspect that you could or
                maybe even dared&quot;</p>
            <div class="container">
