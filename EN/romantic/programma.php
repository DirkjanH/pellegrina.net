    ...
    <div id="inhoud" class="w3-main"> <?php
        ...
        <div id="main">
            <div class="cols2">
                ...
                <img src="/Images/Dvorak.jpg" alt="Antonín Dvořák" class="w3-image"><p>Antonín Dvořák's dramatic ballad <i>The Spectre's Bride</i> composed in 1883 is a work with a powerful musical impact.
