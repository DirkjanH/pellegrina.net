...
//	print_r($filenaam);	
   switch ($filenaam[6])  {
case 'chamber':  $cursus = 3;
		break;
		case 'romantic': $cursus = 2;
		break;
		case 'baroque':  $cursus = 1;
		break;
	}
//	echo 'Cursus is: '.$cursus.'<br>';
	$taal = $filenaam[5];
//	echo 'taal is: '.$taal.'<br>';
require_once ($_SERVER['DOCUMENT_ROOT'].'/includes/navigatie.php');
?>
<!DOCTYPE HTML>
...
<title>Nieuwsbrief La Pellegrina aanvragen</title>
<!-- InstanceEndEditable -->
...
<?php require_once $_SERVER['DOCUMENT_ROOT'].'/NL/adres_toevoegen.php'; ?>
  <!-- InstanceEndEditable -->
