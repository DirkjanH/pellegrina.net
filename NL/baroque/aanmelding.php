...
<body>
  ...
  <div id="inhoud" class="w3-main"> <?php
      ...
      <!-- InstanceBeginEditable name="mainpage" --> <?php // Haal de inleiding + het NAW formulier op
                                                      require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/NAW_NL.php'; ?> <table
          ...
          <td>
            ...
            <SELECT NAME="instr[]" size="17" multiple>
              <OPTGROUP LABEL="Blazers">
                ...
                <OPTION VALUE="116"
                  <?php
                  if (isset($instr) and stristr($instr, '116') !== false) echo 'selected'; ?>>blokfluit
                </OPTION>
                <OPTION VALUE="122"
                  <?php
                  if (isset($instr) and stristr($instr, '122') !== false) echo 'selected'; ?>>barokhobo
                </OPTION>
                <OPTION VALUE="141"
                  <?php
                  if (isset($instr) and stristr($instr, '141') !== false) echo 'selected'; ?>>barokfagot
                </OPTION>
                <OPTION VALUE="160"
                  <?php
              ...
              <OPTGROUP
                ...
                <OPTION VALUE="220"
                  <?php
                  if (isset($instr) and stristr($instr, '220') !== false) echo 'selected'; ?>>altviool
                </OPTION>
                <OPTION VALUE="230"
                  <?php
                ...
                <OPTION VALUE="240"
                  <?php
                  if (isset($instr) and stristr($instr, '240') !== false) echo 'selected'; ?>>contrabas
                </OPTION>
                <OPTION VALUE="250"
                  <?php
                  if (isset($instr) and stristr($instr, '250') !== false) echo 'selected'; ?>>viola da gamba
                  [SVP bij 'opmerkingen' aangeven welke
                  instrumenten je bespeelt: diskant, alt/tenor
                  en/of bas]</OPTION>
              </OPTGROUP>
              <OPTGROUP LABEL="Continuo-instrumenten">
                <OPTION VALUE="320"
                  <?php
                  if (isset($instr) and stristr($instr, '320') !== false) echo 'selected'; ?>>clavecimbel
                </OPTION>
                <OPTION VALUE="330"
                  <?php
                ...
                <OPTION VALUE="340"
                  <?php
                  if (isset($instr) and stristr($instr, '340') !== false) echo 'selected'; ?>>theorbe
                </OPTION>
              </OPTGROUP>
              <OPTION VALUE="000"
                <?php
                if (isset($instr) and stristr($instr, '000') !== false) echo 'selected'; ?>>anders [SVP
                bij 'opmerkingen' beschrijven]</OPTION>
            </SELECT>
          </td>
        </tr>
        <tr>
      ...
      <table class="formulier">
        ...
        <tr>
          ...
          <td><input name="diner" type="checkbox" id="diner" value="1"
              ...
              Hoewel ik mijn eigen accommodatie regel, maak ik
              graag ook gebruik van het gezamenlijke diner<span
                class="nadruk"> (meerprijs
      ...
      <table class="formulier">
        <tr>
          ...
          <td>Ik ben bereid een bedrag van &euro; <input
            ...
            storten in het kortingenfonds&#160;ten behoeve van
            muziekstudenten.&#160;</td>
        </tr>
        <tr>
          <td class="linkerkolom"><input type="checkbox"
