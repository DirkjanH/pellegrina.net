  ...
  <div id="inhoud" class="w3-main"> <?php
      ...
      <div class="container">
        ...
        <p class="citaat">Annelies Jans: &ldquo;Twee repetities 's
          morgens, twee repetities 's middags, en wat doen we op onze
      ...
      <ul>
        ...
        <li>13:00 lunch</li>
        <li>14:15 3e sessie werken aan muziek in kleine ensembles of
          groepsrepetities Vespers</li>
      ...
      <p> Klooster Nieuw Sion bestaat sinds 1890 en was tot 2015 een
        ...
        culturele en muzikale activiteiten plaats. Meer informatie vind
        je hier:</p>
      <ul>
