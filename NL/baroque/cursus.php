...
<body>
    ...
    <div id="inhoud" class="w3-main"> <?php
            ...
            <div class="container">
                ...
                <p class="citaat">Birgit Apfelbaum: &quot;Naar mijn mening maakt La Pellegrina zijn belofte om een stimulerende omgeving te bieden voor toegewijde barokliefhebbers met een professionele instelling volledig waar. Ik heb vooral genoten van de combinatie van het tutti-programma met een groots slotconcert voor externe luisteraars en het werk in kamermuziekensembles onder begeleiding van zeer gemotiveerde coaches, met als hoogtepunt een recital dat door de andere deelnemers werd bijgewoond&quot;</p>
