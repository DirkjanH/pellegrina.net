  ...
  <div id="inhoud" class="w3-main">
    ...
    <div id="main"> <!-- InstanceBeginEditable name="mainpage" -->
      ...
      <ul>
        ...
        <li>Centrale werken voor iedereen: muziek uit Wenen/Praag/Dresden/Kroměříž van onder andere Fux, Caldara, Biber, Zelenka, Michna, Vejvanovský en Schmelzer. Centraal staat het Requiem in f klein van Biber en het Miserere in c klein ZWV 57 van Zelenka</li>
