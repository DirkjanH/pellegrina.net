...
<body>
  ...
  <div id="inhoud" class="w3-main">
    ...
    <div id="main"> <!-- InstanceBeginEditable name="mainpage" -->
      ...
      <ul>
        <li>Voor: zangers (solisten en zeer ervaren koorzangers), instrumentalisten (barokstrijkers, viola da gamba, traverso, barokhobo, barokfagot, baroktrompet & trombone, clavecimbel/orgel, theorbe, uitsluitend ‘oude’ instrumenten, stemtoon 415 Hz)</li>
        ...
        <li>Centrale werken voor iedereen: muziek uit Wenen/Praag/Dresden/Kroměříž van onder andere Fux, Caldara, Biber, Zelenka, Michna, Vejvanovský en Schmelzer. Centraal staat het Requiem in f klein van Biber en het Miserere in c klein ZWV 57 van Zelenka. Deze werken zullen worden uitgevoerd in een openbaar concert in de kloosterkerk</li>
