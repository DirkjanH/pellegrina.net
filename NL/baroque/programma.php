...
<body>
  ...
  <div id="inhoud" class="w3-main"> <?php
      ...
      <div class="cols2">
        ...
        <p>De overgang van renaissance naar barok bracht een verschuiving van polyfonie naar een stijl waarin een duidelijke melodielijn boven een begeleidende bas (basso continuo) centraal stond. Barokmuziek kenmerkt zich door uitbundige versieringen, affectenleer (het uitdrukken van emoties), harmonisch contrapunt en de ontwikkeling van vormen als het concerto grosso en de suite. Instrumenten als het clavecimbel en de viool groeiden uit tot belangrijke begeleidingsinstrumenten, en harmonie werd essentieel voor de opbouw van stukken. De opkomst van de opera als genre, met name in Wenen en later ook in Praag en Dresden, getuigt van de theatrale kant van Centraal-Europese barokmuziek. Kerkmuziek bleef belangrijk, maar kreeg concurrentie van seculiere genres als kamermuziek, dansvormen en de eerste openbare concerten.
        </p>
