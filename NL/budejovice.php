...
<body>
   ...
   <div class="fotorechts"><img src="/Images/Logos/mapacz.gif"
         alt="Kaart van Tsjechië" class="geenlijn" /></div>
   <p>České Budějovice (ook bekend onder de Duitse naam Budweis) is gesticht op
      de plaats van de samenloop van de rivieren Vltava (Moldau) en Malše in
      1265. De historische stad is nog steeds grotendeels in middeleeuwse
      staat. Uit de 13e eeuw is het dominicaanse klooster bewaard. De
      Gotisch-renaissancistische Cerná vež (Zwarte toren) vormt een markante
      dominant van de stad met zijn 72 m en biedt een verrukkelijk uitzicht
      over de stad en omstreken, inclusief de nabije Šumava bergen. Op het
      plein bevindt zich een van de grootste fonteinen in Tsjechië – de
      Samsonfontein. De stad is ook wereldberoemd geworden dankzij het bier
      Budvar, in Amerika geïmiteerd onder de naam Budweiser. Tegenwoordig is
   ...
   <div class="container">
      ...
      <p>Het conservatorium is uitgerust met ruime, goed klinkende werkkamers
         ...
         pianostemmer komt uit Praag om alle instrumenten voor de cursus te
         stemmen. Het gebouw is recent gerenoveerd en heeft nu een lichte en
         prettige uitstraling. </p>
   </div>
   <div class="container">
      ...
      <p class="citaat">Robert Beverly: "La Pellegrina brengt het beste naar
         boven in een nogal diverse en eclectische groep individuen -
         toewijding, motivatie, samenwerking en de onblusbare vreugde van het
         muziek maken."</p>
   </div>
   <div class="container">
      <h4>Maaltijden</h4>
      ...
      <p>Voor degenen die in het conservatorium verblijven, is er een
         ontbijtbuffet in de hal en in een restaurant in de buurt, waar ook
         de lunch wordt geserveerd in de vorm van een buffet. Het avondeten
         is niet inbegrepen in de cursusprijs, behalve op de dagen van
         aankomst en van het slotconcert. In het internaat van het
   ...
   <div class="container">
      ...
      <p class="citaat">Katy en Jan de Jongh: 'Vóór het project gaan we een
         paar dagen naar Praag, en erna uitrusten in de omgeving.
