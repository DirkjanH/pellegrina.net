...
<?php 	
  ...
  <div id="main"> <!-- InstanceBeginEditable name="mainpage" -->
   <h2 class="begin">Toestemming ontvangen</h2>
    <p>Beste deelnemer,</p>
    <p>We hebben je toestemming om je in het adresbestand van <em>La Pellegrina</em> te mogen houden ontvangen, waarvoor dank. Je email-adres en  overige
      gegevens blijven in de mailinglist van <i>La Pellegrina</i>,
      zodat je in de toekomst informatie over zomercursussen en aanverwante
      projecten ontvangt per per email. Als je hebt aangegeven
      dat bepaalde gegevens gewijzigd moeten worden, dan is dat inmiddels gebeurd. </p>
    <p>Alle informatie over de projecten
      van dit jaar vind je op de website <a href="https://www.pellegrina.net">www.pellegrina.net</a>; je ontvangt hierover nu dus geen informatie.
