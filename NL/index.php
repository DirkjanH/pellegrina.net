		...
		<div id="main" class="w3-row-padding">
			<div class="w3-card-2 w3-padding w3-margin-bottom w3-half">
				...
				<div class="w3-panel w3-yellow onzichtbaar">
					<h3 class="w3-text-black">Let op: de data van beide
						cursussen zijn veranderd</h3>
					<p>Als gevolg van wijzigingen op het conservatorium in
						Česk&eacute; Budějovice moesten beide cursussen wat
						later worden gepland.</p>
				</div>
				<p>De zomercursussen in <?php echo $jaar ?>: twee projecten
					waarin je je kunt onderdompelen in een warm bad van
					prachtige muziek, met eersteklas docenten en gelijkgestemde
					zielen. De projecten van <?php echo $jaar ?> staan open voor
					ervaren muzikanten. Of je nou amateur bent of professional,
					bij <em>La Pellegrina </em>staat een professionele
					instelling hoog in het vaandel. Natuurlijk kom je goed
					voorbereid naar een cursus, natuurlijk vind je het fijn als
					anderen dat ook doen. Spreekt dit je aan? Lees dan verder...
				</p>
				<p>Deze pagina geeft een overzicht van de cursussen in
					<?php echo $jaar ?>. De barokcursus vindt plaats in het
					voormalige klooster Nieuw Sion in de bossen van Salland bij
					Deventer. De cursus rond Haydn en Dvořák vindt plaats in
					Tsjechië, het meest muzikale land van Europa. Plaats van
					handeling is het conservatorium van České Budějovice, 120 km
					ten zuiden van Praag. </p>
				<p>Klik op de cursustitels voor meer informatie. <b>Vanaf 1
						december is alle informatie compleet en is de
						inschrijving geopend</b>. </p>
				<p>Mocht je vragen hebben, aarzel dan niet om contact op te
					nemen met Dirkjan Horringa (tel. 0619 224 758).</p>
				...
				<div class="w3-content w3-center">
					<p><a href="/EN/index.php"><img
								src="/Images/Logos/Vlag_UK.jpg"
								alt="Ga naar de Engelstalige site" width="34"
			...
			<div class="w3-half">
				...
				<div class="w3-card-2 w3-padding w3-margin-bottom">
					<h3><a href="https://pellegrina.kinskytrio.cz/"
							target="_blank"><span class="chamber">Extra: Speel
								kamermuziek met het Kinsky Trio Prague &amp;
								Friends</span></a></h3>
					<p>speel met een professionele kamermuziekspeler in de groep
					</p>
					<ul>
						<li>České Budějovice (Tsjechië), 18 - 26 juli
							<?php echo $jaar ?> </li>
					</ul>
					<p class="nadruk">N.B. deze cursus wordt georganiseerd door
						en onder verantwoordelijkheid van het Kinsky Trio
						Prague, in samenwerking met <em>La Pellegrina</em> </p>
				</div>
				<div class="w3-card-2 w3-padding w3-margin-bottom">
