...
<body>
	...
	<div id="inhoud">
		<div id="envelop" class="w3-hide-small w3-hide-medium">
			...
			<div id="" class="onzichtbaar">
				<div class="bannergeel" style="font-size: 100%;">Let op: data zomer 2026 gewijzigd!</div>
			</div>
			<div id="" class="onzichtbaar">
		...
		<div id="main" class="w3-row-padding">
			<div class="w3-card-2 w3-padding w3-margin-bottom w3-half">
				...
				<p>Mocht je vragen hebben, aarzel dan niet om contact op te nemen met Dirkjan Horringa (tel. 0619 224 758).</p>
