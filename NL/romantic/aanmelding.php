   ...
   <table class="formulier" id="instr_kop">
    ...
    <table class="formulier" id="instr_vragen">
      <tr>
        ...
        <td><p><strong>Ik bespeel het volgende instrument c.q. instrumenten: <span class="nadruk">(meerdere keuzes zijn mogelijk door de Ctrl-toets ingedrukt te houden)</span></strong></p>
    ...
    <table class="formulier">
      <tr>
        ...
        <td>Ik ben bereid een bedrag van &euro;
          ...
          te storten in het kortingenfonds&#160;ten behoeve van muziekstudenten en Oosteuropese deelnemers.&#160;</td>
      </tr>
      <tr>
...
<textarea name="opmerkingen" cols="70" rows="5" ><?php if (isset($_POST['opmerkingen'])) echo $_POST['opmerkingen']; ?></textarea></td>
		...
		<table border="0" class="formulier">
		  ...
		  <tr><td><input type="radio" name="betaling" value="transfer"></td>
		...
		<p><input name="submit" type="submit" value="verzenden"><br>
		  <span class="nadruk">(SVP slechts één keer klikken. Je wordt verder geleid naar de betaalpagina of je ontvangt een automatische bevestiging van de verzending)</span></p>
