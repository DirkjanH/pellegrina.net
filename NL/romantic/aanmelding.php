    ...
    <div id="main">
      ...
      <table class="formulier" id="instr_kop">
        <tr>
          ...
          <td><b>Ik meld mij aan als instrumentalist.</b> <span class="nadruk">Vul SVP de vragen die hieronder verschijnen in</span></td>
        </tr>
      </table>
      <table class="formulier" id="instr_vragen">
        <tr>
          ...
          <td>
            <p><strong>Ik bespeel het volgende instrument c.q. instrumenten: <span class="nadruk">(meerdere keuzes zijn mogelijk door de Ctrl-toets ingedrukt te houden)</span></strong></p>
            <SELECT NAME="instr[]" size="19" multiple>
              <OPTGROUP LABEL="Houtblazers">
                <OPTION VALUE="110" <?php
                                    if (isset($instr) and stristr($instr, '110') !== false) echo 'selected'; ?>>dwarsfluit</OPTION>
                <OPTION VALUE="115" <?php
                                    if (isset($instr) and stristr($instr, '115') !== false) echo 'selected'; ?>>piccolo</OPTION>
                <OPTION VALUE="120" <?php
                                    if (isset($instr) and stristr($instr, '120') !== false) echo 'selected'; ?>>hobo</OPTION>
                <OPTION VALUE="130" <?php
                                    if (isset($instr) and stristr($instr, '130') !== false) echo 'selected'; ?>>klarinet Bb/A</OPTION>
                <OPTION VALUE="140" <?php
                                    if (isset($instr) and stristr($instr, '140') !== false) echo 'selected'; ?>>fagot</OPTION>
              </OPTGROUP>
              <OPTGROUP LABEL="Koperblazers">
                <OPTION VALUE="150" <?php
                                    if (isset($instr) and stristr($instr, '150') !== false) echo 'selected'; ?>>hoorn</OPTION>
                <OPTION VALUE="160" <?php
                                    if (isset($instr) and stristr($instr, '160') !== false) echo 'selected'; ?>>trompet</OPTION>
              </OPTGROUP>
              <OPTGROUP LABEL="Strijkinstrumenten">
                <OPTION VALUE="210" <?php
                                    if (isset($instr) and stristr($instr, '210') !== false) echo 'selected'; ?>>viool</OPTION>
                <OPTION VALUE="220" <?php
                                    if (isset($instr) and stristr($instr, '220') !== false) echo 'selected'; ?>>altviool</OPTION>
                <OPTION VALUE="230" <?php
                                    if (isset($instr) and stristr($instr, '230') !== false) echo 'selected'; ?>>cello</OPTION>
                <OPTION VALUE="240" <?php
                                    if (isset($instr) and stristr($instr, '240') !== false) echo 'selected'; ?>>contrabas</OPTION>
              </OPTGROUP>
              <OPTGROUP LABEL="Toetsinstrumenten etc.">
                ...
                <OPTION VALUE="360 " <?php
                                      if (isset($instr) and stristr($instr, '360') !== false) echo 'selected'; ?>>pauken</OPTION>
              </OPTGROUP>
              <OPTION VALUE="000" <?php
                                  if (isset($instr) and stristr($instr, '000') !== false) echo 'selected'; ?>>anders [SVP bij 'opmerkingen' beschrijven]</OPTION>
            </SELECT>
          </td>
        </tr>
        <tr>
          ...
          <td>Niveau:
            ...
            redelijk gevorderd&#160;
            <input type="radio" name="niveau_i"
              value="zeer"
        ...
        <tr>
          <td></td>
          <td><br>
            Noem enkele stukken die je goed beheerst:</td>
        </tr>
        <tr>
          <td></td>
          <td><textarea name="stukken_i" rows="4"><?php
                                                  if (isset($_POST['stukken_i'])) echo $_POST['stukken_i']; ?></textarea></td>
        </tr>
        <tr>
          <td></td>
          <td>Ik heb&#160;
      ...
      <table class="formulier" id="solozang_kop">
        <tr>
          ...
          <td><b>Ik meld mij aan als solozanger.</b> <span class="nadruk">Vul SVP de vragen die hieronder verschijnen in</span></td>
        </tr>
      </table>
      <table class="formulier" id="solozang_vragen">
        ...
        <tr>
          <td></td>
          <td>Noem enkele aria's of rollen die je hebt gestudeerd of nu studeert:</td>
        </tr>
        <tr>
          <td></td>
          <td><strong>
              <textarea name="stukken_s" rows="4"><?php
        ...
        <tr>
          ...
          <td>Ik heb<strong>&#160;
            ...
            </strong>uitgebreide ervaring met zingen in ensembles</td>
        </tr>
      </table>
      <hr>
      <table class="formulier" id="zang_kop">
        <tr>
          ...
          <td><b>Ik meld mij aan als koorzanger.</b> <span class="nadruk">Vul SVP de vragen die hieronder verschijnen in</span></td>
        </tr>
      </table>
      <table class="formulier" id="zang_vragen">
        ...
        <tr>
          ...
          <td>Niveau: 
            ...
            zangstudent
            <input type="radio" name="niveau_z" value="beroeps"
        ...
        <tr>
          <td></td>
          <td><strong>
              <textarea name="stukken_z" rows="4"><?php
        ...
        <tr>
          ...
          <td>Ik heb<strong>&#160;
              ...
              <input type="radio" name="ervaring_z"
                value="veel"
                <?php if (isset($_POST['ervaring_z']) and ($_POST['ervaring_z'] == "veel")) echo 'checked'; ?>>
            </strong>uitgebreide ervaring met zingen in kleine ensembles</td>
        </tr>
      </table>
      <hr>
      <table class="formulier">
        <tr>
          ...
          <td><b>Ik meld mij aan als toehoorder </b><span class="nadruk">(cursusgeld <?php echo euro($cursusdata['toehoorder']); ?>)</span></td>
        </tr>
      </table>
      <hr>
      <p><strong>Standaard accommodatie is een plaats in een tweepersoonskamer in het internaat<span class="budweis"> van het conservatorium</span>. SVP hieronder je voorkeur aangeven als je een ander type accommodatie wilt.</strong></p>
      <table class="formulier">
        <tr>
          ...
          <td>Ik wil bij voorkeur een eenpersoonskamer in het internaat van het conservatorium <span class="nadruk">(meerprijs <?php echo euro($cursusdata['eenpers']) ?>;
      ...
      <table class="formulier">
        <tr>
          ...
          <td>Ik ben bereid een bedrag van &euro;
            ...
            te storten in het kortingenfonds&#160;ten behoeve van muziekstudenten en Oosteuropese deelnemers.&#160;
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>Ik ben burger van een centraaleuropees land of een
            ...
            <span class="nadruk">(zie voor meer informatie <a href="/algemeen/CE_prijzen.php">CE prices</a> of <a href="/algemeen/CZ_prijzen.php">České ceny</a>)</span>
          </td>
        </tr>
        <tr>
          <td colspan="2"><br>
            Verdere opmerkingen en aanvullingen:<br>
            <textarea name="opmerkingen" cols="70" rows="5"><?php if (isset($_POST['opmerkingen'])) echo $_POST['opmerkingen']; ?></textarea>
          </td>
        </tr>
      </table>
      <hr>
      ...
      <table border="0" class="formulier">
        <tr>
          <td class="linkerkolom"><input type="radio" name="betaling" value="mollie" checked></td>
          <td><label>Ik betaal het inschrijfgeld van <?php echo euro($cursusdata['inschrijfgeld']); ?> online, met elektronisch bankieren of creditcard. <span class="nadruk">(N.B. Wanneer je dit formulier verstuurt, word je doorgestuurd naar onze online betalingsdienst. Indien je betaalt met een creditcard houdt de creditcard-maatschappij daarvan een commissie van ca. 3 % in. Dit verrekenen wij met de volgende betaling)</span></label></td>
        </tr>
        <tr>
          <td><input type="radio" name="betaling" value="transfer"></td>
          <td><label>Ik betaal de aanbetaling per bankoverschrijving. <span class="nadruk">(Gebruik deze optie als het cursusgeld lager is dan <?php echo euro($cursusdata['inschrijfgeld'] * 2); ?>, bijvoorbeeld voor de Centraal-Europese of Tsjechische prijzen. De aanbetaling is vereist voor verdere verwerking)</span></label></td>
        </tr>
      </table>
      ...
      <?php require_once '/includes/akkoord_voorwaarden.php'; ?> 
      <div class="w3-panel">
