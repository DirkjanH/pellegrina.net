...
include_once( $_SERVER[ 'DOCUMENT_ROOT' ] . '/includes/includes2019.php' );
...
if ( isset( $_POST[ "submitten" ] ) ) switch ( $_POST[ "submitten" ] ) {
	case "Voeg toe":
		$insertSQL = sprintf( "INSERT INTO docenten (code, naam, achternaam, adres, PC, plaats, land, telefoon, mobiel, email, vak, cursus, 
	...
	case "Update":
		$updateSQL = sprintf( "UPDATE docenten SET code=%s, naam=%s, achternaam=%s, adres=%s, PC=%s, plaats=%s, land=%s, telefoon=%s, mobiel=%s,
...
<body>
<!-- TemplateBeginEditable name="mainpage" -->mainpage<!-- TemplateEndEditable -->
</body>
</html>
	...
	<div class="inhoud w3-panel w3-white">
		<form action="<?php echo $editFormAction; ?>" method="post" name="formulier" id="formulier">
			<table width="100%" border="1" cellpadding="0">
				<tr>
					<td colspan="2">Code:&nbsp;<input name="code" type="text" value="<?php echo $docent['code']; ?>" size="3">&nbsp;Naam:&nbsp;<input name="naam" type="text" value="<?php echo $docent['naam']; ?>">&nbsp;Achternaam:&nbsp;<input name="achternaam" type="text" value="<?php echo $docent['achternaam']; ?>">&nbsp;Foto:&nbsp;<input name="foto" type="text" value="<?php echo $docent['foto']; ?>">&nbsp;Adres:&nbsp;<input name="adres" type="text" value="<?php echo $docent['adres']; ?>">&nbsp;Postcode:&nbsp;<input name="PC" type="text" value="<?php echo $docent['PC']; ?>">&nbsp;Plaats:&nbsp;<input name="plaats" type="text" id="plaats" value="<?php echo $docent['plaats']; ?>">
						<br>Land:&nbsp;<input name="land" type="text" value="<?php echo $docent['land']; ?>">&nbsp;Telefoon:&nbsp;<input name="telefoon" type="text" value="<?php echo $docent['telefoon']; ?>">&nbsp;Mobiel:&nbsp;<input name="mobiel" type="text" value="<?php echo $docent['mobiel']; ?>">&nbsp;Email:&nbsp;<input name="email" type="text" value="<?php echo $docent['email']; ?>">&nbsp;Vak:&nbsp;<input name="vak" type="text" value="<?php echo $docent['vak']; ?>">&nbsp;Cursus:&nbsp;<input name="cursus" type="text" value="<?php echo $docent['cursus']; ?>">&nbsp;</td>
				</tr>
				<tr>
					<td>
						<textarea name="bio_NL" cols="85" rows="20" id="bio_NL"><?php echo $docent['bio_NL']; ?></textarea>
					</td>
					<td>
						<textarea name="bio_EN" cols="85" rows="20" id="bio_EN"><?php echo $docent['bio_EN']; ?></textarea>
					</td>
				</tr>
			</table>
			<p>
				<input onClick="GP_popupConfirmMsg('Moet deze docent werkelijk toegevoegd worden?']; return document.MM_returnValue" type="submit" name="submitten" value="Voeg toe">
				<input name="submitten" type="submit" id="submitten" value="Update">
				<input name="submitten" type="submit" id="submitten" value="Maak leeg">
				<input onClick="GP_popupConfirmMsg('Kan deze docent werkelijk gewist worden?']; return document.MM_returnValue" name="submitten" type="submit" id="submitten" value="Wis docent">
				<input type="hidden" name="DocId" id="DocId" value="<?php echo $_POST['DocId']; ?>">
			</p>
			<p>&nbsp;</p>
			<table width="0%" border="1" cellpadding="4">
				<tr>
					<th width="30">DocId:</th>
					<th width="0"><label>Docent (kies):
				<input type="text" name="zoek_docent" id="zoek_docent" value="<?php if (isset($_POST['zoek_docent']) AND $_POST['zoek_docent'] != '') echo  $_POST['zoek_docent']?>">
				<input name="docent" type="submit" id="docent" value="zoek">
				</label>
					</th>
					<th>Code:</th>
					<th>Cursus:</th>
				...
				<tr>
					<td>
						<?php echo $doc['DocId']; ?>&nbsp;</td>
					<td>
						<a onClick="DocentZoek(<?php echo $doc['DocId']; ?>)">
							<?php echo $doc['naam']; ?>
						</a>&nbsp;</td>
					<td align="center">
						<?php echo $doc['code']; ?>&nbsp;</td>
					<td>
						<?php echo $doc['cursus']; ?>&nbsp;</td>
				</tr>
				<?php
				}
				?>
