            ...
            ?>
               ...
               <tr>
                  <td colspan="<?php echo $aantal_cursussen; ?>" valign="top">
                     <p>Total participants:&nbsp;<?php echo $aangenomen['totaal']; ?> | donations:&nbsp;<?php echo euro($cursus['totaal']['donatie']); ?> |
                        donators: <?php echo $donator['totaal'] . ' (' . round($donator['totaal'] / $aangenomen['totaal'] * 100, 1) . ' %)'; ?> | reductions:&nbsp;<?php echo euro($cursus['totaal']['korting']); ?> | people benefitting from a reduction: <?php echo ($reductor['totaal'] + $reductor2['totaal']) . ' (' . round(($reductor['totaal'] + $reductor2['totaal']) / $aangenomen['totaal'] * 100, 1) . ' %)'; ?></p>
                  </td>
               </tr>
         </table>
         <!-- InstanceEndEditable -->
