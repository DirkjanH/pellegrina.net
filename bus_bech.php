...
require_once ($_SERVER['DOCUMENT_ROOT'].'/includes/includes2022.php');
...
foreach ($cursussen as $cursus) {
	...
	if (is_array($passagiers)) $totalRows_passagiers = count($passagiers); else $totalRows_passagiers = 0;
...
?>
		<tr>
			...
			<td><div align="center"><?php if ($passagier['busheen']==1) echo 'X'; ?>&nbsp;</div></td>
			<td><div align="center"><?php if ($passagier['busterug']==1) echo 'X'; ?>&nbsp;</div></td>
			<td><div align="center">
...
?>
		<tr>
			...
			<td><div align="center"><strong><?php echo $totalRows_heen; ?>&nbsp;</strong></div></td>
			<td><div align="center"><strong><?php echo $totalRows_terug; ?>&nbsp;</strong></div></td>
			<td>&nbsp;</td>
			</tr>
