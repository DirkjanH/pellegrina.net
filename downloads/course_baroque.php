        ...
        <div id="main">
            ...
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td class="w3-center grijs"><a
                            xxxx="https://docs.google.com/spreadsheets/d/e/2PACX-1vT5slBMsznmH15Vxn-ATvg2NtpwgS5Z54GyZ-CMHx9u0GIxOA5NhP5C7yukByBY-aiGbZSIYIrQRwvW/pubhtml?gid=0&single=true"
            ...
            <div class="onzichtbaar">
                ...
                <p>All works we are going to perform are now available here.
                    Please print and study what you need. The string parts will
                    soon have bowings; string players will be notified.</p>
                <p>Singers, please print out the vocal scores and bring them
                    with you. Study the choral parts as well as your solo parts.
                </p>
                ...
                <p>We have made a pastiche of movements from the Utrecht Te Deum
                    & Jubilate and the Ode for St. Cecilia's Day, whch is
                    adapted to the instruments and voices we have during the
                    summer school.</p>
                <ul>
                    <li><a href="/pdf\2025-2\Handel - Pastiche - score_met streken PV.pdf"
                            target="_blank">Handel - Pastiche - Full score
                            <b>with bowings</b>, also for continuo players</a>
                    </li>
                ...
                <ul>
                    ...
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Oboe_2.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Oboe 2</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Recorder_1.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Recorder 1</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Recorder_2.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Recorder 2</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Bassoon.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Bassoon</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Violin_1.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Violin 1</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Violin_2.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Violin 2</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Viola.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Viola</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Harpsichord.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
                            Harpsichord</a></li>
                    <li><a href="/pdf/2025-2/Purcell_Hail!_Bright_Cecilia-Continuo.pdf"
                            target="_blank">Purcell - Hail! Bright Cecilia -
