<a?php require_once $_SERVER['DOCUMENT_ROOT'] . '/includes/cursussen.php' ; $cursusnr=2 + $cursus_offset; ?>
      ...
      <div id="main"> <!-- InstanceBeginEditable name="mainpage" -->
        <table width="100%" border="1">
          ...
          <tr>
            ...
            <td class="w3-center"><a href="La Pellegrina Barok 2024 - Kamermuziek.pdf" target="_blank">Chamber music ensembles</a></td>
