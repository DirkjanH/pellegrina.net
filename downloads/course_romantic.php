    ...
    <div id="inhoud">
        ...
        <div id="main">
            ...
            <div class="onzichtbaar">
                ...
                <ul>
                    <li><a href="../pdf/2025-1/chamberchoir_2025.pdf"
                            target="_blank">Chamber Choir Repertoire 2025</a>
                        (55 pages)</li>
                </ul>
            ...
            <div class="onzichtbaar">
                ...
                <p><a href="../pdf/2025-1/Dvorak_op.109_Das_goldene_Spinnrad.pdf"
                        target="_blank">Full score</a></p>
                <div class="cols3">
                    <ul>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Flute_1-2.pdf"
                                target="_blank">Flute I/II</a></li>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Oboe_1-2,_English_Horn.pdf"
                                target="_blank">Oboe I/II, Cor anglais</a></li>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Clarinet_1-2.pdf"
                                target="_blank">Clarinet I/II</a></li>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Bassoon_1-2,_Contrabassoon.pdf"
                                target="_blank">Bassoon I/II, Contrabassoon</a>
                        </li>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Horn_1-4.pdf"
                                target="_blank">Horn I/II/III/IV</a></li>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Trumpet_1-2.pdf"
                                target="_blank">Trumpet I/II</a></li>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Trombone_1-3,_Tuba.pdf"
                                target="_blank">Trombones I/II/III, Tuba</a>
                        </li>
                        <li><a href="../pdf/2025-1/Zlatý_kolovrat_-_Timpani,_Bass_Drum,_Cymbals,_Triangle.pdf"
                                target="_blank">Timpani & other percussion</a>
                        </li>
                        <li style="break-before: column;"><a
                                href="../pdf/2025-1/Zlatý kolovrat - Violins I - With bowings.pdf"
                                target="_blank">Violin I <b>(with
                                    bowings)</b></a></li>
                        <li><a href="../pdf/2025-1/Zlatý kolovrat - Violins II - With bowings.pdf"
                                target="_blank">Violin II <b>(with
                                    bowings)</b></a></li>
                        <li><a href="../pdf/2025-1/Zlaty Kolovrat, viola (with bowings).pdf"
                                target="_blank">Viola <b>(with bowings)</b></a>
                        </li>
                        <li><a href="../pdf/2025-1/Zlaty Kolovrat, violoncello (with bowings).pdf"
                                target="_blank">Cello <b>(with bowings)</b></a>
                        </li>
                        <li><a href="../pdf/2025-1/Zlaty Kolovrat, contrabasso (with bowings).pdf"
                    ...
                    <p>Singers can download and print the <a
                            href="../pdf/2025-1/Haydn_Paukenmesse_-_vocal score.pdf"
                            target="_blank">vocal score</a></p>
                    <p>MIDI files of some movements of the Haydn Mass</p>
                    <ul>
                        <li><a href="../MIDI/Haydn_Paukenmesse_1_Kyrie.mid"
                                target="_blank">1. Kyrie</a></li>
                        <li><a href="../MIDI/Haydn_Paukenmesse_2_Gloria.mid"
                                target="_blank">2. Gloria</a></li>
                        <li><a href="../MIDI/Haydn_Paukenmesse_4a_Sanctus.mid"
                                target="_blank">4. Sanctus</a></li>
                        <li><a href="../MIDI/Haydn_Paukenmesse_5_Agnus_Dei.mid"
                                target="_blank">5. Agnus Dei</a></li>
                    </ul>
                    <p>Instrumental parts</p>
                    <div class="cols3">
                        <ul>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Flute_solo.pdf"
                                    target="_blank">Flute</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Oboe_1-2_(obbligato).pdf"
                                    target="_blank">Oboe I/II</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_cl 1.pdf"
                                    target="_blank">Clarinet I</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_cl 2.pdf"
                                    target="_blank">Clarinet II</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Bassoon_1-2_(obbligato).pdf"
                                    target="_blank">Bassoon I/II</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Horn_1-2_(C).pdf"
                                    target="_blank">Horn I/II</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Trumpet-Horn_1-2_(ad_lib.)_(C).pdf"
                                    target="_blank">Trumpet I/II</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Timpani.pdf"
                                    target="_blank">Timpani</a></li>
                            <br>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Violins_I_bowings.pdf"
                                    target="_blank">Violin I <b>(with
                                        bowings)</b></a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Violins_II_with_bowings.pdf"
                                    target="_blank">Violin II <b>(with
                                        bowings)</b></a></li>
                            <li><a href="../pdf/2025-1/Haydn - Paukenmesse - viola.pdf"
                                    target="_blank">Viola <b>(with
                                        bowings)</b></a></li>
                            <li><a href="../pdf/2025-1/Haydn Missa in tempore belli HOB XXII.9 cello with bowings.pdf"
                                    target="_blank">Cello <b>(with
                                        bowings)</b></a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Basses.pdf"
                                    target="_blank">Double Bass (without
                                    bowings, please copy the cello bowings
                                    in)</a></li>
                            <li><a href="../pdf/2025-1/Haydn_Paukenmesse_-_Conductor_Score.pdf"
                                    target="_blank">Full score</a></li>
                        </ul>
                    </div>
                    <p><a href="https://open.spotify.com/playlist/6Q0jeTv8wp11eJyxItIBCB?si=3446d002e0fe45ce"
                            target="_blank">Excellent recordings on Spotify to
                            get an impression of the music</a></p>
