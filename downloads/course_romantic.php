      ...
      <div>
        ...
        <div class="cols3">
          <ul>
            ...
            <li style="break-before: column;"><a href="../pdf/2025-1/Zlatý kolovrat - Violins I - With bowings.pdf.crdownload" target="_blank">Violin I <b>(with bowings)</b></a></li>
          ...
          <p style="break-before: column; margin-top: 0">The string parts above do not have bowings. We will use the bowings from the set of parts underneath. As they are badly legible, we ask you to copy their bowings into a clean print of the parts above.</p>
          <ul>
