...
$query_cursus = sprintf("SELECT cursusnaam_en, locatie FROM cursus WHERE CursusId=%s",
...
<div id="cursus_form">
	...
	<div class="w3-panel">
		<div class="w3-panel w3-pale-blue w3-leftbar w3-rightbar w3-border w3-border-blue">
				...
				<ol><li><img src="Images/Logos/ok.png" alt="confirmed" class="geenlijn">&nbsp;means: this ensemble is complete and the work has been fixed</li>
