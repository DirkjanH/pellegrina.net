        ...
        <table class="NAW">
          <tr>
            ...
            <td><input name="geslacht" type="radio" value="M" id="geslacht_man" <?php if (isset($_POST['geslacht']) and ($_POST['geslacht'] == "M")) echo 'checked'; ?> /><label for="geslacht_man">M</label>
              <input name="geslacht" type="radio" value="V" id="geslacht_vrouw" <?php if (isset($_POST['geslacht']) and ($_POST['geslacht'] == "V")) echo 'checked'; ?> /><label for="geslacht_vrouw">F</label>
            </td>
          </tr>
          <tr>
            <td>Middle name:</td>
          ...
          <tr>
            <td>Country:&nbsp;</td>
            <td colspan="4"><input name="taal" type=hidden value="EN">
              <input
                type=text name="land"
                value="<?php
          ...
          <tr>
            ...
            <td colspan="4"><input name="email" type="email" id="email"
              ...
              <span class="nadruk">(obligatory!)</span>
            </td>
          </tr>
        </table>
        <hr>
