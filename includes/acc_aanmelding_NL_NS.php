...
<p><strong> Geef SVP hieronder je voorkeur aan voor je accommodatie.</strong><br>
  <span class="nadruk">De basisprijs is incl. een plaats in een tweepersoonskamer en volpension. Als je dat wilt hoef je niets aan te vinken.</span>
</p>
<table class="formulier">
  ...
  <tr>
    ...
    <td>
      <p>Ik regel mijn eigen accommodatie en maak alleen gebruik van de gezamenlijke lunch, diner en koffie/thee<span class="nadruk"> (korting <?php echo euro($cursusdata['korting_eigen_acc']) ?>)</span></p>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <p>Hoewel ik mijn eigen accommodatie regel, maak ik graag ook gebruik van het gezamenlijke diner<span class="nadruk"> (meerprijs <?php echo euro($cursusdata['diner']) ?>)</span></p>
    </td>
  </tr>
</table>
...
<table class="formulier">
  <tr>
    ...
    <td>Ik ben bereid een bedrag van &euro;
      ...
      te storten in het kortingenfonds&#160;ten behoeve van muziekstudenten.&#160;
    </td>
  </tr>
  <tr>
...
<table border="0" class="formulier">
  ...
  <tr class="">
    ...
    <td>Ik heb de aanbetaling van <?php echo euro($cursusdata['inschrijfgeld']) ?> overgemaakt op bankrekening NL60 BUNQ 2177 4957 25 t.n.v. <em>La Pellegrina</em>,
