<?php Kint::$enabled_mode = false; ?> <div class="<?php echo $filenaam[6] ?>"
	...
	<a class="w3-bar-item w3-button w3-mobile" href="#programma" target="_self"><span class="{$filenaam[6]}">De
    muziek</span></a> 
EOD;
...
<a class="w3-bar-item w3-button w3-mobile" href="#kennismaking"
    target="_self"><span class="{$filenaam[6]}">Kennismakingsrepetitie</span></a>
EOD;

				if ($opening_inschrijving > date('c')) {
					$menu .= <<<EOD
	<a class="w3-bar-item w3-button w3-mobile"
    href="#voorwie" target="_self"><span class="{$filenaam[6]}">Voor wie</span></a>
    <a class="w3-bar-item w3-button w3-mobile" href="#dagindeling"
        target="_self"><span class="{$filenaam[6]}">Week- en dagindeling</span></a>
    <a class="w3-bar-item w3-button w3-mobile" href="#waar"
        target="_self"><span class="{$filenaam[6]}">Waar</span></a>
    <a class="w3-bar-item w3-button w3-mobile" href="#metwie" target="_self"><span class="{$filenaam[6]}">Met
        wie</span></a>
    </div> 
EOD;
				} else {
...
EOD;
				...
				<a class="w3-bar-item w3-button w3-mobile" href="#kennismaking"
	target="_self"><span class="{$filenaam[6]}">Introductory rehearsal</span></a>'
	EOD;
				if ($opening_inschrijving > date('c')) {
					$menu .= <<<EOD
	<a class="w3-bar-item w3-button w3-mobile" href="#voorwie"
	...
	<a class="w3-bar-item w3-button w3-mobile" href="#dagindeling"
		target="_self"><span class="{$filenaam[6]}">Week and day programme</span></a>
	<a class="w3-bar-item w3-button w3-mobile" href="#waar"
		target="_self"><span class="{$filenaam[6]}">Where</span></a>
	<a class="w3-bar-item w3-button w3-mobile" href="#metwie"
		target="_self"><span class="{$filenaam[6]}">With whom</span></a>
	</div> 
EOD;
				} else {
					$menu .= <<<EOD
	...
	target="_self"><span class="{$filenaam[6]}">For whom</span></a>
	<a class="w3-bar-item w3-button w3-mobile"
		href="#dagindeling" target="_self"><span class="{$filenaam[6]}">Week and day
		programme</span></a>
	<a class="w3-bar-item w3-button w3-mobile" href="#waar"
		target="_self"><span class="{$filenaam[6]}">Where</span></a>
	<a class="w3-bar-item w3-button w3-mobile" href="#metwie"
		target="_self"><span class="{$filenaam[6]}">With whom</span></a>
	<a class="w3-bar-item w3-button w3-mobile"
		href="aanmelding.php" target="_self"><span class="{$filenaam[6]}">Registration</span></a>
	</div> 
EOD;
				}
			}
