...
require_once ($_SERVER["CONTEXT_DOCUMENT_ROOT"].'/connections/connect_PDO.php');

//Connection statement
require_once ($_SERVER["CONTEXT_DOCUMENT_ROOT"].'/connections/inschrijf.php');
...
$minimumleeftijd = 10;
$maximumleeftijd = 88;
$opening_inschrijving = date('2017-12-01');
