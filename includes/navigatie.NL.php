...
<nav class="w3-sidenav w3-collapse w3-card-2 w3-large" id="navcontainer">
    <ul id="navlist">
        ...
        <li><a href="plaats.php" target="_parent" -->{locatie}, de locatie</a>
        </li>
        <div class="w3-accordion"> <a onclick="myAccFunc('LP')" href="#"><em>La
                    Pellegrina</em> <i class="fa fa-caret-down"></i></a>
            <div id="LP" class="w3-accordion-content w3-white w3-card-4">
                ...
                <li><a href="../privacy.php">Privacy en Algemene verordening
                        gegevensbescherming (AVG)</a></li>
            </div>
        </div>
        <li><a href="docenten.php" target="_parent" -->Docenten</a></li>
        <li><a href="praktisch.php">Prijzen & praktische zaken</a></li>
        ...
        <li><a href="login.php" target="_parent">Speciaal voor deelnemers</a>
        </li>
    </ul>
    <div class="w3-content w3-center"> <a href="/EN/index.php" target="_parent">
            <img src="/Images/Logos/Vlag_UK.jpg"
                alt="Ga naar de Engelstalige site" width="34" height="24"
                class="geenlijn" /></a> <a
            href="https://www.facebook.com/pellegrina.net"
            title="Vind La Pellegrina op Facebook" target="_blank"><img
                src="/Images/Logos/facebook_logo.png" alt="Facebook" width="25"
                height="25" class="geenlijn" /></a> </div>
</nav>
<script>
function w3_open() {
