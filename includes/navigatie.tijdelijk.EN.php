...
<nav class="w3-sidenav w3-collapse w3-card-2 w3-large" id="navcontainer">
  <ul id="navlist">
    ...
    <li class="grijs"><a <!--href="cursus.php" target="_parent">Course details</a></li>
      <li><a class="grijs" <!--href="aanmelding.php" target="_parent">Registration</a></li>
    ...
    <div class="w3-accordion">
    <a onclick="myAccFunc('praktisch')" href="#">Practical matters <i class="fa fa-caret-down"></i></a>
        <div id="praktisch" class="w3-accordion-content w3-white w3-card-4">
            <li><a  class="grijs" <!--href="praktisch.php" target="_parent"-->Practical & prices</a></li>
    ...
    <li><a class="grijs" <!--href="login.php" target="_parent"-->For participants only</a></li>
  </ul>
