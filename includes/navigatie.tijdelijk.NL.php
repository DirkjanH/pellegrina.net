...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-card-2 w3-large"
    ...
    <li class="grijs"><a <!--href="cursus.php"
            class="w3-bar-item w3-button">Cursusdetails</a>
        ...
        <div class="w3-accordion">
            ...
            <div id="LP" class="w3-accordion-content w3-white w3-card-4">
                ...
                <a href="vorigeprojecten.php"
                    class="w3-bar-item w3-button">Eerdere projecten</a>
                <a href="/algemeen/werken.php"
                    class="w3-bar-item w3-button">Eerder uitgevoerde werken</a>
        ...
        <a href="adres_toevoegen.php" target="_parent"
            ...
            E-mail op!</a>
        <a class="grijs w3-bar-item w3-button" <!--href="login.php"
            target="_parent" -->Speciaal voor deelnemers</a>
