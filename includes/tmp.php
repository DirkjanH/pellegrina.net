...
<li>Je aanmelding wordt verwerkt zodra de <b>aanbetaling van €&nbsp;{$cursusdata['inschrijfgeld']}</b> is ontvangen op rekening NL33 ASNB 0707 2500 72 (BIC ASNB NL21) t.n.v. <em>La Pellegrina</em>, Utrecht</li>                     <li>Je ontvangt dan een voorlopige bevestiging van inschrijving. Uiterlijk
...
if (isset($geboortedatum))echo safestrtotime('d-m-Y',$geboortedatum); else echo '[dd-mm-jjjj]'; ?>" /></td>
    ...
    <h1 class="<?php echo $filenaam[5] ?> cursusnaam"><?php echo $cursusdata['cursusnaam_nl']; ?></h1>
    <p class="<?php echo $filenaam[5] ?>"><strong><?php echo $cursusdata['cursusplaats_nl'] . ', ' . $cursusdata['datum']; ?></strong></p>
    <p>De prijs van het project bedraagt <strong><?php echo euro($cursusdata['prijs_volledig']) ?></strong> per
      persoon, exclusief accommodatie en maaltijden.</p>
