<a?php // stel php in dat deze fouten weergeeft //ini_set('display_errors', 1);
    error_reporting(E_ALL); require_once $_SERVER["DOCUMENT_ROOT"]
    . '/vendor/autoload.php' ; use function PHP81_BC\strftime;
    Kint::$enabled_mode=false; require_once($_SERVER['DOCUMENT_ROOT']
    . '/includes/includes2025.php' ); function getisp($ip='' ) { if ($ip=='' )
    $ip=$_SERVER['REMOTE_ADDR']; $longisp=@gethostbyaddr($ip); $isp=explode('.',
    $longisp); $isp=array_reverse($isp); $tmp=$isp[1]; if
    (preg_match("/\<(org?|com?|net)\>/i", $tmp)) { $myisp = $isp[2] . '.' .
    $isp[1] . '.' . $isp[0]; } else { $myisp = $isp[1] . '.' . $isp[0]; }
    preg_match("/[0-9]{1,3}\.[0-9]{1,3}/", $myisp); return $myisp; } ?>
    <!DOCTYPE html>
    <html>
    ...
    <head>
        ...
        <meta name="Description"
            content="Musical Summer Schools for advanced musical amateurs, chamber music and orchestra">
        <meta name="Keywords"
            content="Barokmuziek, klassieke muziek, zingen, muziekmaken, Kamermuziek, Kleine ensembles, Koorzang, Muziekcursus, Muziekliefhebbers, Muziekvakantie, Solozang, Tsjechië muziek, Vocaal ensemble, Workshop, Zomercursus, 
        ...
        <meta charset="utf-8">
        <meta name="verify-v1"
            content="CNpSvvR+TC1YnI2of9XUZf1olPLIrNYnXNIraar7VLI=" />
        ...
        <link rel="manifest"
            href="https://www.pellegrina.net/Images/Logos/site.webmanifest">
...
<![endif]-->
        ...
        <meta name="verify-v1"
            content="vR6h4zMZYm0o19dhXiI5yeZrVu5fueMcCb/+Hsp+g4g=" />
    ...
    <body>
            ...
            <div id="envelop" class="w3-hide-small w3-hide-medium">
                <div id="banner">
                    <div id="bannerteksten" class="bannergeel"
                        style="font-size: 75%;">
                        <div class="">Data zomer 2025 bekend; inschrijving start
                            1 december!</div>
                        <div class="">Dates summer 2025 are known; registration
                    ...
                    <div id="" class="banneroranje onzichtbaar">
                        <div class="onzichtbaar">Nog enkele plaatsen
                            beschikbaar... </div>
                        <div class="onzichtbaar">A few last places available...
                        </div>
                    </div>
                    <div id="" class="bannerrood onzichtbaar">
                        <div class="onzichtbaar">De cursussen in 2025 zijn
                            helemaal vol</div>
                        <div class="onzichtbaar">The 2025 courses are fully
                            booked </div>
                    </div>
                    <div id="" class="onzichtbaar">
                        <div class="onzichtbaar">Wie zich vóór 1 maart aanmeldt,
                            krijgt € 50 korting</div>
                        <div class="onzichtbaar">Who registers before 1 March,
                            receives a EUR 50 red.</div>
                    </div>
                </div>
            </div>
            <div id="home"
        ...
        <noscript>
            ...
            powered by <a href="http://www.olark.com?welcome"
