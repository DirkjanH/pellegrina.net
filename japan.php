  ...
  <div id="inhoud">
    ...
    <div id="main">
      <div class="japans">
        ...
        <ol>
          <li><strong>室内楽とオーケストラによる合唱曲のコース</strong>(7/24 (木) - 8/3 (日) České Budějovice)：ハイドンの『戦時のミサ』を中心としたオーケストラ、合唱団、ソリストのためのコース。オーケストラはドヴォルザークの交響詩『金の紡ぎ車』作品109も演奏します。このコースの特徴は、室内楽（午前）とオーケストラ練習（午後）の組み合わせにあります。従ってオケ一つ分の人数と歌手が集められます。足らないパートは毎年近隣のオーケストラからチェコ人が特別参加しています。室内楽は最後に団内発表会があります。オーケストラ曲はコンセルヴァトワールでリハーサルされ、チェスケ・ブディェヨヴィツェ大聖堂でコンサート形式で演奏されます。Petr Bernášek, Pavel Hořejší、Libor Nováček , Rudolf Sternadel, Jitka Vlašánkova　(以上弦楽器), Martina Bernášková(フルート)、Mitchell Sandler(歌), Dirkjan Horringa(アンサンブル)その他が指導します。室内楽の課題は2曲で、個人あるいはPreformed(事前に組んだグループ)で選曲してエントリーすることもできます。弦楽四重奏のほか、管楽器、ピアノとのアンサンブルなど大きな編成の曲も可能で、最終的には参加者が出揃った段階で編成と曲目が連絡されます。 またモーツァルト協奏曲の夕べが自由参加で催されます。</li>
          <li><strong>バロック音楽コース</strong>（8/10 (日) - 8/16 (土) Nieuw Sionの修道院にて）：各種古楽器(A-415、弦楽器はガット弦使用)と合唱のコースで、2つのプログラムで構成されています。レパートリーのメインテーマは、Purcell & Handelと彼の同時代の作品で構成される夜の礼拝曲で、メンバー全員が参加する。午前は教室でグループに分かれて古楽器と歌の小編成のアンサンブル曲で、午後はグループリハーサルと教会での全体練習です。最後に室内楽の発表会と修道院のチャペルでカンタータ・コンサートが催されます。指導者はDirkjan Horringa (singers and artistic direction)、Femke Huizinga (orchestra, violin), Hanna Lindeijer (baroque winds), Mitchell Sandler (singers), Edoardo Valorz (basso continuo)です</li>
        </ol>
        <h3>申し込み</h3>
