    ...
    <div id="main">
      <div class="japans">
        ...
        <ol>
          ...
          <li><strong>室内楽とオーケストラによる合唱曲のコース</strong>(7/30 (木) - 8/9 (日) České Budějovice)：ハイドンの『戦時のミサ』を中心としたオーケストラ、合唱団、ソリストのためのコース。オーケストラはドヴォルザークの交響詩『金の紡ぎ車』作品109も演奏します。このコースの特徴は、室内楽（午前）とオーケストラ練習（午後）の組み合わせにあります。従ってオケ一つ分の人数と歌手が集められます。足らないパートは毎年近隣のオーケストラからチェコ人が特別参加しています。室内楽は最後に団内発表会があります。オーケストラ曲はコンセルヴァトワールでリハーサルされ、チェスケ・ブディェヨヴィツェ大聖堂でコンサート形式で演奏されます。Petr Bernášek, Pavel Hořejší、Libor Nováček , Rudolf Sternadel, Jitka Vlašánkova　(以上弦楽器), Martina Bernášková(フルート)、Mitchell Sandler(歌), Dirkjan Horringa(アンサンブル)その他が指導します。室内楽の課題は2曲で、個人あるいはPreformed(事前に組んだグループ)で選曲してエントリーすることもできます。弦楽四重奏のほか、管楽器、ピアノとのアンサンブルなど大きな編成の曲も可能で、最終的には参加者が出揃った段階で編成と曲目が連絡されます。 またモーツァルト協奏曲の夕べが自由参加で催されます。</li>
