  ...
  <div id="inhoud">
    ...
    <div id="main">
      <div class="japans">
        ...
        <ol>
          <li><strong>室内楽と合唱曲（オーケストラ伴奏付き）コース</strong>(7月30日（木）～8月9日（日）チェスケー・ブジェヨヴィツェ)：オーケストラ、合唱団、ソリストのためのコース。ドヴォルザークのカンタータ『花嫁の衣』作品69に重点を置いています。このコースの特徴は、室内楽（午前）とオーケストラのリハーサル（午後）を組み合わせていることです。そのため、十分な数の音楽家や歌手が集められます。不足しているパートは、毎年、近隣のオーケストラのチェコ人音楽家によって補われます。室内楽は、コース終了時に内部発表会で演奏されます。オーケストラ作品は、音楽院でリハーサルを行い、チェスケー・ブジェヨヴィツェ大聖堂でのコンサートで演奏されます。ペトル・ベルナシェク、パヴェル・ホレジシ、リボル・ノヴァチェク、ルドルフ・ステルナデル、イットカ・ヴラシャンコヴァ（上記の弦楽器）、マルティナ・ベルナシュコヴァ（フルート）、ミッチェル・サンドラー（声楽）、ディルクヤン・ホリンガ（アンサンブル）などが指導にあたります。室内楽の課題は2曲で構成され、個別に、または事前に編成されたグループで選択して提出することができます（事前に編成されたグループ）。弦楽四重奏団のほか、管楽器やピアノを含むより大規模な編成も可能です。編成とプログラムは、参加者全員が確定した時点で最終的に発表されます。また、自由に参加できるモーツァルトのコンサートナイトも開催されます。<li>
          <li><strong>バロック音楽コース</strong>（8月13日（木）から8月19日（水）まで、ニューシオン修道院で開催）：さまざまな歴史的楽器（A-415、羊腸弦の弦楽器）と合唱のためのコースで、2つのプログラムで構成されています。レパートリーは主に、中央ヨーロッパのバロック音楽と、その同時代の人々の作品で構成されており、夕方の礼拝で演奏されます。夕方の礼拝には、すべての参加者が参加します。午前中は、参加者はグループに分かれ、教室で古楽器や小編成のアンサンブルの練習を行います。午後には、グループ練習と教会での合同練習が行われます。コースの終わりには、室内コンサートと、修道院の礼拝堂でのカンタータコンサートが開催されます。講師は、ディルクヤン・ホリンガ（歌手および芸術監督）、フェムケ・ホイジンガ（オーケストラ、ヴァイオリン）、ハンナ・リンデイヤー（バロック管楽器）、ミッチェル・サンドラー（歌手）、エドアルド・ヴァロルツ（通奏低音）です。</li>
          <li><strong>室内楽とオーケストラによる合唱曲のコース</strong>(7/30 (木) - 8/9 (日) České Budějovice)：オーケストラ、合唱団、ソリストのための講座。ドヴォルザークのカンタータ『幽霊の花嫁』作品69に焦点を当てた。オーケストラはドヴォルザークの交響詩『金の紡ぎ車』作品109も演奏します。このコースの特徴は、室内楽（午前）とオーケストラ練習（午後）の組み合わせにあります。従ってオケ一つ分の人数と歌手が集められます。足らないパートは毎年近隣のオーケストラからチェコ人が特別参加しています。室内楽は最後に団内発表会があります。オーケストラ曲はコンセルヴァトワールでリハーサルされ、チェスケ・ブディェヨヴィツェ大聖堂でコンサート形式で演奏されます。Petr Bernášek, Pavel Hořejší、Libor Nováček , Rudolf Sternadel, Jitka Vlašánkova　(以上弦楽器), Martina Bernášková(フルート)、Mitchell Sandler(歌), Dirkjan Horringa(アンサンブル)その他が指導します。室内楽の課題は2曲で、個人あるいはPreformed(事前に組んだグループ)で選曲してエントリーすることもできます。弦楽四重奏のほか、管楽器、ピアノとのアンサンブルなど大きな編成の曲も可能で、最終的には参加者が出揃った段階で編成と曲目が連絡されます。 またモーツァルト協奏曲の夕べが自由参加で催されます。</li>
