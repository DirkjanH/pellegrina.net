  ...
  <div id="inhoud">
    ...
    <div id="main">
      <div class="japans">
        <h1>2026年コース案内(概要)</h1>
        <h4>(2025 年12月更新)</h4>
        <div class="fotocenter"><img src="Images/japan.jpg" class="w3-image" alt="Japanese participants playing chamber music in Czechia"></div>
        <h3>主催者からのメッセージ</h3>
        ...
        <ol>
          <li><strong>室内楽とオーケストラによる合唱曲のコース</strong>(7/30 (木) - 8/9 (日) České Budějovice)：オーケストラ、合唱団、ソリストのための講座。ドヴォルザークのカンタータ『幽霊の花嫁』作品69に焦点を当てた。このコースの特徴は、室内楽（午前）とオーケストラ練習（午後）の組み合わせにあります。従ってオケ一つ分の人数と歌手が集められます。足らないパートは毎年近隣のオーケストラからチェコ人が特別参加しています。室内楽は最後に団内発表会があります。オーケストラ曲はコンセルヴァトワールでリハーサルされ、チェスケ・ブディェヨヴィツェ大聖堂でコンサート形式で演奏されます。Petr Bernášek, Pavel Hořejší、Libor Nováček , Rudolf Sternadel, Jitka Vlašánkova　(以上弦楽器), Martina Bernášková(フルート)、Mitchell Sandler(歌), Dirkjan Horringa(アンサンブル)その他が指導します。室内楽の課題は2曲で、個人あるいはPreformed(事前に組んだグループ)で選曲してエントリーすることもできます。弦楽四重奏のほか、管楽器、ピアノとのアンサンブルなど大きな編成の曲も可能で、最終的には参加者が出揃った段階で編成と曲目が連絡されます。 またモーツァルト協奏曲の夕べが自由参加で催されます。</li>
          <li><strong>バロック音楽コース</strong>（8/13 (日) - 8/19 (土) Nieuw Sionの修道院にて）：各種古楽器(A-415、弦楽器はガット弦使用)と合唱のコースで、2つのプログラムで構成されています。レパートリーのメインテーマは、Baroque Music from Central Europeと彼の同時代の作品で構成される夜の礼拝曲で、メンバー全員が参加する。午前は教室でグループに分かれて古楽器と歌の小編成のアンサンブル曲で、午後はグループリハーサルと教会での全体練習です。最後に室内楽の発表会と修道院のチャペルでカンタータ・コンサートが催されます。指導者はDirkjan Horringa (singers and artistic direction)、Femke Huizinga (orchestra, violin), Hanna Lindeijer (baroque winds), Mitchell Sandler (singers), Edoardo Valorz (basso continuo)です</li>
        </ol>
        <h3>申し込み</h3>
