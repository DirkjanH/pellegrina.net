...
<div class="w3-content w3-white">
	<h3 class="w3-panel w3-blue-gray">Aantal afwezigen inzeepdag: <?php 
	if (isset($aangenomen) and $aangenomen > 0) $percentage = round($aantal_niet/$aangenomen*100, 0) . ' %'; else $percentage = '?';
		echo $aantal_niet . ' van ' . $aangenomen . ' (' . $percentage . ')'; ?><button class="w3-right w3-red w3-btn w3-small" form="form1" type="submit" name="instr" value="achternaam">Sorteer op achternaam</button> &nbsp;&nbsp;<button class="w3-right w3-green w3-btn w3-small" form="form1" type="submit" name="instr" value="instr">Sorteer op instrument</button></h3>
