...
// *************************************************************************************************
//
// THIS IS THE USER LEVEL 2 ACCEPTANCE CHECK
// ADD OR INCLUDE THIS AT THE TOP OF ANY PAGES THAT ALLOW USER LEVEL 2 ACCESS 
...
if ($_COOKIE['login']['level'] != "2" and $_COOKIE['login']['level'] != "3" and $_COOKIE['login']['level'] != "4") {
