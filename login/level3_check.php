...
// *************************************************************************************************
//
// THIS IS THE USER LEVEL 3 ACCEPTANCE CHECK
// ADD OR INCLUDE THIS AT THE TOP OF ANY PAGES THAT ALLOW USER LEVEL 3 ACCESS 
...
if ($_COOKIE['login']['level'] != "3" and $_COOKIE['login']['level'] != "4") {
