...
if (isset($_POST['Submit']))
{
	...
	if(mysql_num_rows($result)>0)
	{
		...
		if($password == $row["user_pass"])
		{
			...
			setcookie('loginok', "ok", $jaar, '/');
			setcookie('username', $username, $jaar, '/');
			setcookie('password', $password, $jaar, '/');
			setcookie('level', $row["user_level"], $jaar, '/');

			header("Location: ../Downloads/index.htm");
...
<script src="http://asset.userfly.com/users/18932/userfly.js" type="text/javascript"></script>
</head>

<body>
<p align="center" class="nadruk"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Please 
