...
d.d. {$insch['datum_inschr']}"; ?>&nbsp;
					...
					<tr valign="middle">
						...
						<td><input name="info_korting" type="checkbox" id="info_korting" value="1" <?php if (!(strcmp($insch['info_korting'], 1))) {
																										echo "checked";
																									} ?> /></td>
					...
					<tr valign="middle">
						...
						<td><input name="meerdaneen" type="checkbox" id="meerdaneen" value="1" <?php if (!(strcmp($insch['meerdaneen'], 1))) {
																									echo "checked";
																								} ?> /></td>
					...
					<tr valign="baseline">
						...
						<td height="30"><input name="afgewezen" type="checkbox" id="afgewezen" <?php if (!(strcmp($insch['afgewezen'], 1))) {
																									echo "checked";
																								} ?> /></td>
						<td>&nbsp;</td>
					</tr>
					...
					<tr valign="baseline">
						...
						<td><?php d($insch); ?>
							<input type="checkbox" name="voorl_bev" <?php if ($insch['voorl_bev'] > 0) {
																		echo "checked";
																		$voorl_bev = TRUE;
																	} ?> />
						</td>
