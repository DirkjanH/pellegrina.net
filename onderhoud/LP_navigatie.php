...
<body>
	<form name="form1" method="post" href="<?php echo $editFormhref; ?>">
		<div class="w3-cell-row" style="max-width: 400px;">
			...
			<div class="w3-cell w3-mobile"><a class="button" href="LP_bezettingen.php">Bezettingen</a>
			</div>
			<div class="w3-cell w3-mobile"><a class="button" href="LP_herhaling.php">Herhaling</a>
			</div>
			<div class="w3-cell w3-mobile"><a class="button" href="LP_wanbetalers.php">Aanm. cursusgeld</a>
			</div>
			...
			<div class="w3-cell w3-mobile"><a class="button" href="LP_financieel.php">Voorl. bevestiging</a>
			</div>
			<div class="w3-cell w3-mobile"><a class="button" href="LP_rekening.php">Rekening</a>
			</div>
