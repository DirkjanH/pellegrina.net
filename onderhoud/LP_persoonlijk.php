		...
		<div id="mainpage" class="w3-panel w3-white">
			<table border="0" align="left" width="100%">
				<td>
					...
					<form name="inschrijvingsform" method="POST"
						...
						<table border="1" align="left">
							...
							<tr valign="baseline">
								...
								<td valign="bottom">
									<table>
										<tr>
											<td><input type="radio"
													name="geslacht" value="M" <?php if (!(strcmp($inschrijving['geslacht'], "M"))) {
																					echo "CHECKED";
																				} ?> /> Man </td>
											<td><input type="radio"
													name="geslacht" value="V" <?php if (!(strcmp($inschrijving['geslacht'], "V"))) {
																					echo "CHECKED";
																				} ?> /> Vrouw </td>
										</tr>
									</table>
								<td align="right" valign="bottom" nowrap>Taal:
								</td>
								<td valign="bottom"><input type="text"
										name="taal"
							...
							<tr valign="baseline">
								...
								<td colspan="3">
									<textarea name="publiciteit" cols="45"
										rows="2"
							...
							<tr valign="baseline">
								...
								<td colspan="2"><input type="text"
										name="telefoon" value="<?php if (empty($tel) or $tel == '') echo $inschrijving['telefoon'];
																else echo $tel; ?>" size="45" />
								</td>
								<td rowspan="2" valign="middle"><input
										name="bewerk" type="submit" id="bewerk"
										value="bewerk" />
								</td>
							</tr>
							<tr valign="baseline">
								<td nowrap align="right">Mobiel:</td>
								<td colspan="2"><input type="text" name="mobiel"
										value="<?php if (empty($mobiel) or $mobiel == " ") echo $inschrijving['mobiel'];
							...
							<tr valign="baseline">
								...
								<td colspan="3"><input type="text" name="email"
										value="<?php if (!isset($email)) echo $inschrijving['email'];
							...
							<tr valign="baseline">
								<td colspan="4" align="right" nowrap
									class="nadruk">De gegevens hieronder
									veranderen met &quot;Wijzig adres&quot;</td>
							</tr>
							<tr valign="baseline">
							...
							<tr valign="baseline">
								...
								<td colspan="3"><input name="postcode"
										type="text"
							...
							<tr valign="baseline">
								<td nowrap align="right"><input
										name="Wijzigdlnmr" type="submit"
										id="Wijzigdlnmr" value="Wijzig dlnmr" />
								</td>
								...
								<td><input name="Leegmaken" type="submit"
										id="Leegmaken" value="Leegmaken" />
								</td>
							</tr>
						</table>
					</form>
