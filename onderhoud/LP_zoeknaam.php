...
<body>
	<div class="w3-panel">
		<form id="vinden" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			<label>Naam: </label><input name="zoeknaam" type="text" id="zoeknaam2" size="14" value="<?php echo $_POST['zoeknaam']; ?>"> <a href="javascript:wis()" class="w3-text-red w3-hover-white w3-padding-16" style="text-decoration: none;"><b>X</b></a><br>
