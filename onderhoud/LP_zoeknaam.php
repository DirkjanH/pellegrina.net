...
<body>
	<div class="w3-panel">
		<form id="vinden" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
			<label>Naam: </label><input name="zoeknaam" type="text" id="zoeknaam" size="14" value="<?php echo $_POST['zoeknaam']; ?>"> <a href="javascript:wis()" class="w3-text-red" style="text-decoration: none;"><b>X</b></a><br>
