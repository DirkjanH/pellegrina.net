...
$query_ensembles = sprintf("SELECT CONCAT_WS(', ', componist, titel) as stuk, ensemble.opmerking, ensemble.Id as ensembleId, docent1, docent2, ruimte, link FROM ensemble, werk WHERE CursusId_FK=%s AND `set`=%s AND WerkId = werk.Id AND WerkId > 0
...
$query_docenten = sprintf("SELECT DocId, code FROM cursusdocenten, docenten
...
<button ACCESSKEY="b" name="cursus" type="button"
	onClick="CursusZoek(1)">Course 1 <span class="toets">(Shift-Alt-1)</span></button>
<button ACCESSKEY="k" name="cursus" type="button" 
	onClick="CursusZoek(2)">Course 2 <span class="toets">(Shift-Alt-2)</span></button>
<button ACCESSKEY="r" name="cursus" type="button"
	onClick="CursusZoek(3)">Course 3 <span class="toets">(Shift-Alt-3)</span></button>
