...
<div id="inhoud" class="w3-content" style="width: 100%; max-width: 1200px;">
  <form action="<?php echo $editFormAction; ?>" method="post" name="formulier" id="formulier">
		<div class="w3-panel w3-left"><strong>Lists of participants </strong>including  not yet accepted:
          ...
          including postulated: <input <?php if (!(strcmp($_POST['gepostuleerd'],1))) {echo "checked=\"checked\"";}?> name="gepostuleerd" type="checkbox" id="gepostuleerd" value="1">
			 including refused or cancelled: <input <?php if (!(strcmp($_POST['gecanceld'],1))) {echo "checked=\"checked\"";}?> name="gecanceld" type="checkbox" id="gecanceld" value="1">
		</div>
        <?php 
		$i = $eerstecursus;
