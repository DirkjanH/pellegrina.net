...
<head>
   ...
   <title>Onderhoud database La Pellegrina</title>
</head>
<frameset rows="*" cols="250,*" frameborder="NO" border="0" framespacing="0">
   <frame src="zoeknaam.php" name="leftFrame" frameborder="yes" scrolling="auto" noresize title="leftFrame">
   <frameset rows="70,*" frameborder="no" border="1" framespacing="0">
      <frame src="update_navigatie.php" name="topFrame" frameborder="no" scrolling="auto" title="topFrame">
      <frame src="update_statistiek.php" name="mainFrame" scrolling="yes" marginheight="10" title="mainFrame">
   </frameset>
</frameset>
<noframes>
<body>
