...
if (empty($_GET['DlnmrId']) or $_GET['DlnmrId'] == "" or $_POST['leegmaken'] == 'Leegmaken') $id = -1;
...
if ((isset($_POST["bevestig"])) && ($_POST["bevestig"] == "Bevestig aanmelding")) {
  $updateSQL = sprintf(
    "UPDATE inschrijving SET storting_fonds=%s, donatie=%F, aanbetaling=now(), aangebracht=%s, aangenomen=%s, voorl_bev=CURDATE(), info_korting=%s,
    ...
    <form action="<?php echo $editFormAction; ?>" method="POST" name="update" id="update">
      ...
      <tr valign="baseline">
        ...
        <td><input type="checkbox" name="storting_fonds" value="1" <?php
                                                                    if ($insch['storting_fonds'] == 1 or $insch['donatie'] > 0) {
                                                                      echo "checked";
                                                                    } ?> /></td>
      ...
      <tr valign="middle">
        ...
        <td><input name="info_korting" type="checkbox" id="info_korting" value="1" <?php if (!(strcmp(
                                                                                      $insch['info_korting'],
                                                                                      1
                                                                                    ))) {
                                                                                      echo "checked";
      ...
      <tr valign="middle">
        ...
        <td><input name="meerdaneen" type="checkbox" id="meerdaneen" value="1" <?php if (!(strcmp(
                                                                                  $insch['meerdaneen'],
                                                                                  1
                                                                                ))) {
                                                                                  echo "checked";
      ...
      <tr valign="baseline">
        ...
        <td><input name="aangenomen" type="checkbox" id="aangenomen" value="1" <?php if (!(strcmp($insch['aangenomen'], 1))) {
                                                                                  echo "checked";
                                                                                } ?> />
          <label>Leeftijd:&nbsp;
      ...
      <tr valign="baseline">
        ...
        <td>&#8364;&nbsp;
          <input type="text" name="cursusgeld" value="<?php if (
                                                        isset($_GET['DlnmrId'])
                                                        and $_GET['DlnmrId'] > 0
        ...
        <td>&#8364;&nbsp;
          ...
          <INPUT TYPE="button" NAME="inschr" VALUE="€ 250"
            onClick="self.document.update.aanbet_bedrag.value='250'">
        </td>
        <td>&nbsp;</td>
      </tr>
      <tr valign="baseline">
        <td>
          <div align="right">Voorlopige bevestiging: <?php echo ($insch['voorl_bev']); ?></div>
        </td>
        <td><input type="checkbox" name="voorl_bev" <?php if ($insch['voorl_bev'] > 0) {
                                                      echo "checked";
                                                      $voorl_bev = TRUE;
                                                    } ?> /></td>
