...
<p>&nbsp;</p>
  <table width="626" border="0" style="clear: both;">
    ...
    <tr valign="baseline">
      ...
      <td><input name="maaltijdpas" type="checkbox" id="maaltijdpas" value="1" <?php if (!(strcmp($ins['maaltijdpas'],"1"))) {echo "checked";} ?> />
         &nbsp;&nbsp;&nbsp;&nbsp;ACMP&nbsp;&nbsp;
         <input name="ACMP" type="checkbox" id="ACMP" value="1" <?php if (!(strcmp($ins['ACMP'],"1"))) {echo "checked";} ?> /></td>
    </tr>
    <tr valign="baseline">
