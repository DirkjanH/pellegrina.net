    ...
    <table width="626" border="0" style="clear: both;">
      <tr valign="baseline">
        ...
        <td width="247">Deelnemersnummer:
          <input name="DlnmrId_FK" type="text" value="<?php echo stripslashes($ins['DlnmrId_FK']); ?>" size="3">
        </td>
      </tr>
      <tr valign="baseline">
        ...
        <td colspan="3"><?php if ($ins['CursusId_FK'] != "") echo "Inschrijving nr. <input name=\"InschId\" type=\"text\" class=\"uit\" value=\"{$ins['InschId']}\" size=\"2\">&nbsp;<b>{$cursus[$ins['CursusId_FK']]['cursusnaam_nl']}</b>"; ?>
          <input name="CursusId_FK" type="hidden" value="<?php echo stripslashes($ins['CursusId_FK']); ?>">
        </td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td width="119"><input type="checkbox" name="groot_ensemble1" value="1" <?php if (!(strcmp($ins['groot_ensemble1'], "1"))) {
                                                                                  echo "checked";
                                                                                } ?> /></td>
        <td width="123" align="right" nowrap>Groot_ensemble2:</td>
        <td><input type="checkbox" name="groot_ensemble2" value="1" <?php if (!(strcmp($ins['groot_ensemble2'], "1"))) {
                                                                      echo "checked";
                                                                    } ?> /></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td colspan="3"><input type="checkbox" name="toehoorder" value="1" <?php if (!(strcmp($ins['toehoorder'], "1"))) {
                                                                              echo "checked";
                                                                            } ?> /></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        ...
        <td>&euro;&nbsp;
          <input type="text" name="aanbet_bedrag" value="<?php echo stripslashes($ins['aanbet_bedrag']); ?>" size="5" />
        </td>
        <td>Cursusgeld:</td>
        <td>&euro;&nbsp;
          <input name="cursusgeld" type="text" value="<?php echo stripslashes($ins['cursusgeld']); ?>" size="6" />
        </td>
      </tr>
      <tr valign="baseline">
