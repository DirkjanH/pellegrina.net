...
if (isset($_GET['DlnmrId']) and ($_GET['DlnmrId'] != "") and isset($_POST["Wissen"]) and ($_POST['Wissen'] == "Wissen")) {
   ...
   $Adressen = $inschrijf->SelectLimit($query_Adressen) or die($inschrijf->ErrorMsg());
   ...
   if ($aantal == 1) {
      ...
      $Result1 = $inschrijf->Execute($deleteadresSQL) or die($inschrijf->ErrorMsg());
   } else echo "Er zijn meer personen met dit adres. Het adres kan niet gewist worden<br>";

   $deleteSQL = sprintf(
      "DELETE FROM dlnmr WHERE DlnmrId=%s",
            ...
            <table border="1" align="left">
               ...
               <tr valign="baseline">
                  ...
                  <td colspan="3"><input type="text" name="geboortedatum" value="<?php echo $inschrijving->Fields('geboortedatum'); ?>" size="10" />
                     ...
                     &nbsp;student:&nbsp;<input name="student" type="checkbox" id="student" value="1"
                        <?php if (!(strcmp($inschrijving->Fields('student'), "1"))) {
                           echo "checked";
                        } ?>>
                     &nbsp;oost:&nbsp;<input name="oost" type="checkbox" id="student" value="1"
                        <?php if (!(strcmp($inschrijving->Fields('oost'), "1"))) {
                           echo "checked";
                        } ?>>
                  </td>
               </tr>
               <tr valign="baseline">
                  ...
                  <td valign="bottom">
                     <table>
                        <tr>
                           <td><input type="radio" name="geslacht" value="M" <?php if (!(strcmp($inschrijving->Fields('geslacht'), "M"))) {
                                                                                 echo "CHECKED";
                                                                              } ?> />
                              Man</td>
                           <td><input type="radio" name="geslacht" value="V" <?php if (!(strcmp($inschrijving->Fields('geslacht'), "V"))) {
                                                                                 echo "CHECKED";
                                                                              } ?> />
                              Vrouw</td>
                        </tr>
               ...
               <tr valign="baseline">
                  ...
                  <td colspan="2"><input type="text" name="telefoon" value="<?php if (!isset($tel)) echo $inschrijving->Fields('telefoon');
                                                                              else echo $tel;
                                                                              ?>" size="45" /></td>
               ...
               <tr valign="baseline">
                  ...
                  <td colspan="2"><input type="text" name="mobiel" value="<?php if (!isset($mobiel)) echo $inschrijving->Fields('mobiel');
                                                                           else echo $mobiel; ?>" size="45" /></td>
               </tr>
               <tr valign="baseline">
                  <td nowrap align="right">Email:</td>
                  <td colspan="3"><input type="text" name="email" value="<?php if (!isset($email)) echo $inschrijving->Fields('email');
                                                                           else echo $email; ?>" size="45" /></td>
               </tr>
               <tr valign="baseline">
