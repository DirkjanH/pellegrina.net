...
<meta charset="utf-8">
<!-- InstanceBeginEditable name="doctitle" --><title>LP statistiek</title>
<!-- InstanceEndEditable -->
...
<div id="inhoud">
	<header id="navigatiebalk">
		<?php require_once('navigatie_nieuw.php');?>
	</header>
	<div id="mainpage"><!-- InstanceBeginEditable name="Mainpage" -->
	<div class="w3-panel">
...
?>
			...
			<tr>
				<td colspan="<?php echo $aantal_cursussen; ?>" valign="top">
					<p>Totaal aangenomen deelnemers:&nbsp;
						...
						<?php echo euro($cursus['totaal']['cursusgeld'] + $cursus['totaal']['donatie'] 
	 /* - $cursus['totaal']['korting'] */); ?>
					...
					<p>Totaal al betaald:&nbsp;
						...
						<?php if ($aangenomen['totaal'] - $deelnemers_vorigjaar['totaal'] >= 0) echo '+'; else echo '-'; echo $aangenomen['totaal'] - $deelnemers_vorigjaar['totaal']; ?>)
					</p>
				</td>
			</tr>
		</table>
