...
if ( ( isset( $_POST[ "Verwerk" ] ) ) && ( $_POST[ "Verwerk" ] == "Verwerk betaling" ) && $_POST[ 'InschId' ] != "" ) {
	...
	$updateSQL = sprintf( "UPDATE inschrijving SET aanbet_bedrag=%s, rekening_opmerking=%s WHERE InschId=%s",
...
if (is_array($openstaand)) $totalRows_openstaand = count( $openstaand ); else $totalRows_openstaand = 0;
...
<table width="100%" border="0">
	<tr>
		<td colspan="2"><form id="zoek" name="zoek" method="get" action="<?php echo $editFormAction; ?>">
				Id:
...
if ($totalRows_inschrijving > 1) {
		...
		echo "<form action=\"{$editFormAction}\" method=\"get\" name=\"inschrijving\" id=\"inschrijving\"> \n <select name=\"cursus\" size=\"{$totalRows_inschrijving}\" >";
      	foreach ($inschrijving as $ins){
			...
			if (!(strcmp($ins['CursusId_FK'], $_GET['cursus']))) {echo "SELECTED"; $inschrijving[0] = $ins;}
...
?>
	<form action="<?php echo $editFormAction; ?>" method="POST" name="form" id="form">
		<tr>
			<td height="50" colspan="2" valign="top"><h2>Naam:&nbsp;<?php echo $ins['naam']; ?></h2>
			...
			echo $ins['CursusId_FK']; ?>"></td>
		</tr>
		<tr valign="baseline">
			<td width="100" align="right" nowrap><div align="right">Cursusgeld:</div></td>
			<td><?php echo euro2($ins['cursusgeld']); ?></td>
		</tr>
		<tr valign="baseline">
			<td width="100"><div align="right">Gedoneerd bedrag: </div></td>
			<td><?php echo euro2($ins['donatie']); ?></td>
		</tr>
		<tr valign="baseline">
			<td width="100" align="right" nowrap><div align="right">Totaal te betalen: </div></td>
			<td><?php echo euro2($ins['cursusgeld'] + $ins['donatie']); ?>&nbsp;</td>
		</tr>
		<tr valign="baseline">
			<td width="100" align="right" nowrap><div align="right">Al betaald:</div></td>
			<td><?php echo euro2($ins['aanbet_bedrag']); ?></td>
		</tr>
		<tr valign="middle">
			<td width="100" align="right" valign="top" nowrap><div align="right">Nog openstaand </div></td>
		...
		<tr valign="middle">
			<td colspan="2" valign="top" nowrap><div align="left">Opmerkingen over de betaling:<br>
