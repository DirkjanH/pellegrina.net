  ...
  <form id="inschrijf" name="inschrijf" method="post" action="<?php echo $editFormAction; ?>">
    ...
    <table width="626" border="0" style="clear: both;">
      ...
      <tr valign="baseline">
        ...
        <td width="119"><input type="checkbox" name="zanger" id="zang_checkbox" value="1" <?php if (!(strcmp($ins['zanger'], "1"))) {
                                                                                            echo "checked";
                                                                                          } ?> /></td>
      ...
      <tr valign="baseline">
        ...
        <td><input name="diner" type="checkbox" id="diner" value="1" <?php if (!(strcmp($ins['diner'], "1"))) {
                                                                        echo "checked";
                                                                      } ?> />
      </tr>
      <tr valign="baseline">
